...
#define SF   FP     // single-float is floating-point
#define DF   DP     // double-float is double-floating-point
...
// SEEK case insensitive equality , cieq any of 2, any of 3, any of 4
#define CIEQ(str, str1)                    STREQCI(str, str1)
#define CIEQ2(str, str1, str2)             STREQANY2CI(str, str1, str2)
#define CIEQ3(str, str1, str2, str3)       STREQANY3CI(str, str1, str2, str3)
#define CIEQ4(str, str1, str2, str3, str4) STREQANY4CI(str, str1, str2, str3, str4)
...
#define Maybe	'm'
// yes no maybe ...
// presumably will have to remap Y and N later
// or override by src req
...
#define cM2(f, s1, s2)	MLOG2(f, s1, s2);
#define eM2(f, s1, s2)	MERR2(f, s1, s2);
#define cW2(f, s1, s2)	WLOG2(f, s1, s2);
// cW2 colourWhite2 because W2 is Web2
...
#define cM3(f, s1, s2, s3)	MLOG3(f, s1, s2, s3);
#define cW3(f, s1, s2, s3)	WLOG3(f, s1, s2, s3);
